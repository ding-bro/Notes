...
#include "../../../Third-party/qmarkdowntextedit/qmarkdowntextedit.h"
...
void QMarkdownTextEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        QMarkdownTextEdit *_t = static_cast<QMarkdownTextEdit *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (QMarkdownTextEdit::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QMarkdownTextEdit::urlClicked)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (QMarkdownTextEdit::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QMarkdownTextEdit::zoomIn)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (QMarkdownTextEdit::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QMarkdownTextEdit::zoomOut)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject QMarkdownTextEdit::staticMetaObject = {
    { &QPlainTextEdit::staticMetaObject, qt_meta_stringdata_QMarkdownTextEdit.data,
      qt_meta_data_QMarkdownTextEdit,  qt_static_metacall, nullptr, nullptr}
};
...
void *QMarkdownTextEdit::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QMarkdownTextEdit.stringdata0))
        return static_cast<void*>(const_cast< QMarkdownTextEdit*>(this));
