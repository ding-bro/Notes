...
#include "../../../Third-party/qmarkdowntextedit/markdownhighlighter.h"
...
void MarkdownHighlighter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (MarkdownHighlighter::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MarkdownHighlighter::highlightingFinished)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject MarkdownHighlighter::staticMetaObject = {
    { &QSyntaxHighlighter::staticMetaObject, qt_meta_stringdata_MarkdownHighlighter.data,
      qt_meta_data_MarkdownHighlighter,  qt_static_metacall, nullptr, nullptr}
};
